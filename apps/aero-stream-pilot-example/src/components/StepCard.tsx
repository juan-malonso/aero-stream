...
export function StepCard({ children, title, subtitle, description, message }: StepCardProps) {
  return (
    <div style={{ height: '100%', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', fontFamily: 'sans-serif', boxSizing: 'border-box', padding: '1rem' }}>
      <div style={{ width: '100%', maxWidth: '80%', height: '80%', maxHeight: '80%', backgroundColor: '#ffffff', borderRadius: '1rem', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ width: '100%', flexGrow: 1, padding: '2rem 1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxSizing: 'border-box', overflowY: 'auto' }}>
          {children}
        </div>
      </div>
    </div>
