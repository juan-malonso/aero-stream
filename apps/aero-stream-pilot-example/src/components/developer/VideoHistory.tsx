            ...
            return (
              ...
              >
                ...
                <button 
                  ...
                  disabled={isActive}
                  style={{ width: '100%', marginTop: '0.25rem', padding: '0.5rem', backgroundColor: isActive ? '#f9ba61' : '#ffffff', color: isActive ? '#ffffff' : '#4b5563', fontSize: '0.875rem', fontWeight: 500, border: '1px solid #d1d5db', borderRadius: '0.375rem', cursor: isActive ? 'not-allowed' : 'pointer' }}
                >
